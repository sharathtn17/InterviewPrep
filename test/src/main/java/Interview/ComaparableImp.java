...
public class ComaparableImp {
	...
	public static void main(String args[])
	{
		...
		Bottles bot5=new Bottles(3,"Aluminium","CElicoware");
		
		List<Bottles> Ab=new ArrayList<Bottles>();
		//Set<Bottles> Ab=new HashSet<Bottles>();
		Ab.add(bot1);
		Ab.add(bot2);
		Ab.add(bot3);
		System.out.println(Ab.add(bot4));
		System.out.println(Ab.add(bot5));
...
class Bottles implements Comparable<Bottles>{
	...
	public int compareTo(Bottles o) {
